...
function sendemail_verify($name,$email,$verify_token){
    $mail = new PHPMailer(true);
        ...
        $mail->Username   = 'doydorarina0@gmail.com';                    
        $mail->Password   = 'tvztwpsvnjyowwt';                               
        ...
        //Attachments
        $mail->setFrom('doydorarina0@gmail.com',$name);         //Add attachments
        $mail->addAddress($email);    //Optional name

        //Content
        $mail->isHTML(true);                                  //Set email format to HTML
        $mail->Subject = 'Email verification from ynnaa';

        $mail->template    = "
           <h2>You have Registered with Luna</h2>
           <h5>Verify your email address to login with the below given link</h5>
           <br/><br/>
           <a href='http://localhost/Rina%20Doydora/log%20in%20registration%20with%20in%20email/$verify_token'> Click Me </a>";
